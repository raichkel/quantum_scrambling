...
function main(T=5.0, N=21; H="MF", Δ=1, Bx=0.01,Bz=0.01, Jx=1.0, Jy=0.75, Jz=1.25 )
    ...
    plot(times,log.(C_r_t_5), label="r=5", left_margin=20px,top_margin = 20px,
        right_margin=20px, bottom_margin = 20px, framestyle=:box, linecolor=get(ColorSchemes.seaborn_rocket_gradient,0.15))#, ylim=(min_y, 20)) #, ylim=(min_y, 20)
    #scatter!(times,log.(C_r_t_2), ylim=(min_y, 20))
    plot!(times,log.(C_r_t_10), label="r=10", linecolor=get(ColorSchemes.seaborn_rocket_gradient,0.2))#, ylim=(min_y, 20)) #!
    #scatter!(times,log.(C_r_t_4), ylim=(min_y, 20))
    plot!(times,log.(C_r_t_20), label="r=20", linecolor=get(ColorSchemes.seaborn_rocket_gradient, 0.25))#, ylim=(min_y, 20))
    #scatter!(times,log.(C_r_t_6), ylim=(min_y, 20))
    plot!(times,log.(C_r_t_30), label="r=30", linecolor=get(ColorSchemes.seaborn_rocket_gradient, 0.3))#, ylim=(min_y, 20))

    plot!(times,log.(C_r_t_40), label="r=40", linecolor=get(ColorSchemes.seaborn_rocket_gradient,0.35))#, ylim=(min_y, 20))

    plot!(times,log.(C_r_t_50), label="r=50", linecolor=get(ColorSchemes.seaborn_rocket_gradient, 0.4))#, ylim=(min_y, 20))
