...
function main(T=5.0, N=21; H="MF", Δ=1 )
    ...
    plot(times,log.(C_r_t_5), ylim=(min_y, 20), label="r=5")
    #scatter!(times,log.(C_r_t_2), ylim=(min_y, 20))
    plot!(times,log.(C_r_t_10), ylim=(min_y, 20), label="r=10") #!
    #scatter!(times,log.(C_r_t_4), ylim=(min_y, 20))
    plot!(times,log.(C_r_t_20), ylim=(min_y, 20), label="r=20")
    #scatter!(times,log.(C_r_t_6), ylim=(min_y, 20))
    plot!(times,log.(C_r_t_30), ylim=(min_y, 20), label="r=30")

    plot!(times,log.(C_r_t_40), ylim=(min_y, 20), label="r=40")

    plot!(times,log.(C_r_t_50), ylim=(min_y, 20), label="r=50")
