...
function commutator_H(N, hx, hz, J; H="MF",Δ=1, B=0.1)
...
function main(T=5.0, N=21; H="MF", Δ=1, B=0.1 )
    ...
    println(C_r_t_5)
    println(C_r_t_10)
    plot(times,log.(C_r_t_5), label="r=5", left_margin=20px, ylim=(min_y, 20)) #, ylim=(min_y, 20)
    #scatter!(times,log.(C_r_t_2), ylim=(min_y, 20))
    plot!(times,log.(C_r_t_10), label="r=10", left_margin=20px, ylim=(min_y, 20)) #!
    #scatter!(times,log.(C_r_t_4), ylim=(min_y, 20))
    # plot!(times,log.(C_r_t_20), label="r=20", left_margin=20px, ylim=(min_y, 20))
    # #scatter!(times,log.(C_r_t_6), ylim=(min_y, 20))
    # plot!(times,log.(C_r_t_30), label="r=30", left_margin=20px, ylim=(min_y, 20))

    # plot!(times,log.(C_r_t_40), label="r=40", left_margin=20px, ylim=(min_y, 20))

    # plot!(times,log.(C_r_t_50), label="r=50", left_margin=20px, ylim=(min_y, 20))
