...
function anticommutator_H(N;Jx=1.0,Jy=0.75,Jz=1.25)
...
function main(T=5.0, N=21,  β=0.1; Jx=1.0, Jy=0.75, Jz=1.25 )
    ...
    H_op_a = anticommutator_H(N; Jx=Jx,Jy=Jy,Jz=Jz)
