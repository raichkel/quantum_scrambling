...
function main(T=5.0, N=21; t = 2.0, U = 1.0, μ = 1.0)
    ...
    function measure_commutator(; psi, bond, half_sweep)
        ...
        n_60_system, n_60_ancilla= local_op(N,sitesext;r=35)
        n_70_system, n_70_ancilla= local_op(N,sitesext;r=45)
        n_80_system, n_80_ancilla= local_op(N,sitesext;r=25)
        n_90_system, n_90_ancilla= local_op(N,sitesext;r=15)
