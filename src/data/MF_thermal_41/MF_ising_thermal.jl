...
function anticommutator_H(N, hx, hz, J;)
...
function main(T=5.0, N=21, β=0.1;)
    ...
    H_op_a = anticommutator_H(N, hx, hz,J;)
    ...
    function measure_commutator(; psi, bond, half_sweep)
        ...
        Sx_60_system, Sx_60_ancilla= local_op(N,sitesext;r=10)
        Sx_70_system, Sx_70_ancilla= local_op(N,sitesext;r=10)
        Sx_80_system, Sx_80_ancilla= local_op(N,sitesext;r=10)
        Sx_90_system, Sx_90_ancilla= local_op(N,sitesext;r=10)
