...
function main(T=5.0, N=21; H="MF", β=0.1, Jx=1.0, Jy=0.75, Jz=1.25 )
    ...
    function measure_commutator(; psi, bond, half_sweep)
        ...
        Sx_60_system, Sx_60_ancilla= local_op(N,sitesext;r=50)
        Sx_70_system, Sx_70_ancilla= local_op(N,sitesext;r=50)
        Sx_80_system, Sx_80_ancilla= local_op(N,sitesext;r=50)
        Sx_90_system, Sx_90_ancilla= local_op(N,sitesext;r=50)
